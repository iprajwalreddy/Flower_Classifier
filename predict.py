...
training_loader, testing_loader, validation_loader,train_data,validation_data = futils.load_data()
model, optimizer, criterion = futils.nn_setup()

futils.save_checkpoint(path)
