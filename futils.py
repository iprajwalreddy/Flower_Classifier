...
def load_data(where  = "./flowers" ):
    ...
    return trainloader,vloader,testloader,train_data,validation_data

trainloader,vloader,testloader,train_data,validation_data = load_data()
...
def predict(input_image, model, topk=5,power='gpu'):
    '''
